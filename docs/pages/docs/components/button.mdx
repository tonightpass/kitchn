...
|------|------|---------|----------|-------------
| `children` | `React.ReactNode` | `undefined` | Yes | Content to be displayed inside the button.
...
| `type` | `'primary' \| 'secondary' \| 'danger' \| 'warning' \| 'success' \| 'info' \| 'dark' \| 'light'` | `'primary'` | No | Visual style variant of the button.
...
| `onClick` | `(event: React.MouseEvent) => void` | `undefined` | No | Function called when the button is clicked.