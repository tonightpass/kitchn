...
| `type` | `'primary' \| 'secondary' \| 'danger' \| 'warning' \| 'success' \| 'info' \| 'dark' \| 'light'` | `'primary'` | No | The type of the button, determining its color based on [`AccentColors`](/docs/theming#accent).
