...
First, you need to import the `useCurrentState` hook from your custom hooks file.
...
|----------------|------------------|---------------------------------------------------
| `initialState` | `S` or `() => S` | The initial state value, or a function that returns the initial state.
