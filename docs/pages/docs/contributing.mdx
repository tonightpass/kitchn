---
title: "How to Contribute to Kitchn: A Guide for Beginners and Experts"
...
# Or to work on documentation:
pnpm dev:docs  # Starts the documentation development server
```
